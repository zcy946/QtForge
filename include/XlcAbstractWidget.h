 ...
 */
  ...
  *
  * @note
  * 子类必须实现 initItems()，并在构造函数中显式调用 setupUi()。
  * initLayout / initConnections / initWidget 为可选步骤：无内容时可不重写（基类默认为空）。
  */
 ...
 protected:
     ...
     // 若某步无逻辑，可省略对应 override，使用基类默认空实现。
 };
